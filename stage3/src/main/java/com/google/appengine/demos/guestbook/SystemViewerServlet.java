...
/**
 *
 * @author ludo at google dot com 
 */
@WebServlet(name = "systemviewer", urlPatterns = {"/SystemViewer"})
public class SystemViewerServlet extends HttpServlet {
